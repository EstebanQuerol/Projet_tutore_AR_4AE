...
O_SRCS += \
../lib/ARToolKit/examples/simpleLite/simpleLite.o 

C_SRCS += \
../lib/ARToolKit/examples/simpleLite/simpleLite.c 

OBJS += \
./lib/ARToolKit/examples/simpleLite/simpleLite.o 

C_DEPS += \
./lib/ARToolKit/examples/simpleLite/simpleLite.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/simpleLite/%.o: ../lib/ARToolKit/examples/simpleLite/%.c
	@echo 'Building file: $<'

...
C_SRCS += \
../lib/ARToolKit/examples/simpleVRML/object.c \
../lib/ARToolKit/examples/simpleVRML/simpleVRML.c 

OBJS += \
./lib/ARToolKit/examples/simpleVRML/object.o \
./lib/ARToolKit/examples/simpleVRML/simpleVRML.o 

C_DEPS += \
./lib/ARToolKit/examples/simpleVRML/object.d \
./lib/ARToolKit/examples/simpleVRML/simpleVRML.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/simpleVRML/%.o: ../lib/ARToolKit/examples/simpleVRML/%.c
	@echo 'Building file: $<'

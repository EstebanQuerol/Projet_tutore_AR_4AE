...
CPP_SRCS += \
../lib/ARToolKit/lib/SRC/ARvrml/arViewer.cpp \
../lib/ARToolKit/lib/SRC/ARvrml/arViewerCapi.cpp 

OBJS += \
./lib/ARToolKit/lib/SRC/ARvrml/arViewer.o \
./lib/ARToolKit/lib/SRC/ARvrml/arViewerCapi.o 

CPP_DEPS += \
./lib/ARToolKit/lib/SRC/ARvrml/arViewer.d \
./lib/ARToolKit/lib/SRC/ARvrml/arViewerCapi.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/lib/SRC/ARvrml/%.o: ../lib/ARToolKit/lib/SRC/ARvrml/%.cpp
	@echo 'Building file: $<'

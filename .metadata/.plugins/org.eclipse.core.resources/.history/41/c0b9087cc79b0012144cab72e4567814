...
O_SRCS += \
../lib/ARToolKit/examples/exview/draw_object.o \
../lib/ARToolKit/examples/exview/exview.o 

C_SRCS += \
../lib/ARToolKit/examples/exview/draw_object.c \
../lib/ARToolKit/examples/exview/exview.c 
...
C_DEPS += \
./lib/ARToolKit/examples/exview/draw_object.d \
./lib/ARToolKit/examples/exview/exview.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/exview/%.o: ../lib/ARToolKit/examples/exview/%.c
	@echo 'Building file: $<'

...
C_SRCS += \
../lib/ARToolKit/lib/SRC/VideoGStreamer/video.c 

OBJS += \
./lib/ARToolKit/lib/SRC/VideoGStreamer/video.o 

C_DEPS += \
./lib/ARToolKit/lib/SRC/VideoGStreamer/video.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/lib/SRC/VideoGStreamer/%.o: ../lib/ARToolKit/lib/SRC/VideoGStreamer/%.c
	@echo 'Building file: $<'

...
CPP_SRCS += \
../lib/ARToolKit/lib/SRC/VideoWin32.DEPRECATED/videoWin32.cpp 

OBJS += \
./lib/ARToolKit/lib/SRC/VideoWin32.DEPRECATED/videoWin32.o 

CPP_DEPS += \
./lib/ARToolKit/lib/SRC/VideoWin32.DEPRECATED/videoWin32.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/lib/SRC/VideoWin32.DEPRECATED/%.o: ../lib/ARToolKit/lib/SRC/VideoWin32.DEPRECATED/%.cpp
	@echo 'Building file: $<'

...
O_SRCS += \
../lib/ARToolKit/util/videoTest/videoTest.o 

C_SRCS += \
../lib/ARToolKit/util/videoTest/videoTest.c 

OBJS += \
./lib/ARToolKit/util/videoTest/videoTest.o 

C_DEPS += \
./lib/ARToolKit/util/videoTest/videoTest.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/util/videoTest/%.o: ../lib/ARToolKit/util/videoTest/%.c
	@echo 'Building file: $<'

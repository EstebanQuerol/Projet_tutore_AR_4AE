...
O_SRCS += \
../lib/ARToolKit/examples/collide/collideTest.o \
../lib/ARToolKit/examples/collide/object.o 

C_SRCS += \
../lib/ARToolKit/examples/collide/collideTest.c \
../lib/ARToolKit/examples/collide/object.c 
...
C_DEPS += \
./lib/ARToolKit/examples/collide/collideTest.d \
./lib/ARToolKit/examples/collide/object.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/collide/%.o: ../lib/ARToolKit/examples/collide/%.c
	@echo 'Building file: $<'

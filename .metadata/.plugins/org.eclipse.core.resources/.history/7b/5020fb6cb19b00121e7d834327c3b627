...
O_SRCS += \
../lib/ARToolKit/examples/multi/multiTest.o 

C_SRCS += \
../lib/ARToolKit/examples/multi/multiTest.c 

OBJS += \
./lib/ARToolKit/examples/multi/multiTest.o 

C_DEPS += \
./lib/ARToolKit/examples/multi/multiTest.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/multi/%.o: ../lib/ARToolKit/examples/multi/%.c
	@echo 'Building file: $<'

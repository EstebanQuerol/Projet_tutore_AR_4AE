...
C_SRCS += \
../lib/ARToolKit/lib/SRC/VideoMacOSX/video.c 

OBJS += \
./lib/ARToolKit/lib/SRC/VideoMacOSX/video.o 

C_DEPS += \
./lib/ARToolKit/lib/SRC/VideoMacOSX/video.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/lib/SRC/VideoMacOSX/%.o: ../lib/ARToolKit/lib/SRC/VideoMacOSX/%.c
	@echo 'Building file: $<'

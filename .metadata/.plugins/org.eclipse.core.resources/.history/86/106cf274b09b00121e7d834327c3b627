...
O_SRCS += \
../lib/ARToolKit/examples/loadMultiple/loadMultiple.o \
../lib/ARToolKit/examples/loadMultiple/object.o 

C_SRCS += \
../lib/ARToolKit/examples/loadMultiple/loadMultiple.c \
../lib/ARToolKit/examples/loadMultiple/object.c 
...
C_DEPS += \
./lib/ARToolKit/examples/loadMultiple/loadMultiple.d \
./lib/ARToolKit/examples/loadMultiple/object.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/loadMultiple/%.o: ../lib/ARToolKit/examples/loadMultiple/%.c
	@echo 'Building file: $<'

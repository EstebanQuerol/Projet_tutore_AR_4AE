...
C_SRCS += \
../lib/ARToolKit/lib/SRC/VideoLinuxDV/video.c 

OBJS += \
./lib/ARToolKit/lib/SRC/VideoLinuxDV/video.o 

C_DEPS += \
./lib/ARToolKit/lib/SRC/VideoLinuxDV/video.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/lib/SRC/VideoLinuxDV/%.o: ../lib/ARToolKit/lib/SRC/VideoLinuxDV/%.c
	@echo 'Building file: $<'

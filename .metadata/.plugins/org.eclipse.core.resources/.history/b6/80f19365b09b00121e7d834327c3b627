...
O_SRCS += \
../lib/ARToolKit/examples/relation/relationTest.o 

C_SRCS += \
../lib/ARToolKit/examples/relation/relationTest.c 

OBJS += \
./lib/ARToolKit/examples/relation/relationTest.o 

C_DEPS += \
./lib/ARToolKit/examples/relation/relationTest.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/relation/%.o: ../lib/ARToolKit/examples/relation/%.c
	@echo 'Building file: $<'

...
C_SRCS += \
../lib/glfw-2.7.6/lib/cocoa/cocoa_thread.c 

OBJS += \
./lib/glfw-2.7.6/lib/cocoa/cocoa_thread.o 

C_DEPS += \
./lib/glfw-2.7.6/lib/cocoa/cocoa_thread.d 


# Each subdirectory must supply rules for building sources it contributes
lib/glfw-2.7.6/lib/cocoa/%.o: ../lib/glfw-2.7.6/lib/cocoa/%.c
	@echo 'Building file: $<'

...
C_SRCS += \
../lib/ARToolKit/bin/Data/multi/patt.c 

OBJS += \
./lib/ARToolKit/bin/Data/multi/patt.o 

C_DEPS += \
./lib/ARToolKit/bin/Data/multi/patt.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/bin/Data/multi/%.o: ../lib/ARToolKit/bin/Data/multi/%.c
	@echo 'Building file: $<'

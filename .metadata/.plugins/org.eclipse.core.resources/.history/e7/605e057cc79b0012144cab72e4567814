...
O_SRCS += \
../lib/ARToolKit/examples/paddle/paddle.o \
../lib/ARToolKit/examples/paddle/paddleTest.o 

C_SRCS += \
../lib/ARToolKit/examples/paddle/paddle.c \
../lib/ARToolKit/examples/paddle/paddleTest.c 
...
C_DEPS += \
./lib/ARToolKit/examples/paddle/paddle.d \
./lib/ARToolKit/examples/paddle/paddleTest.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/paddle/%.o: ../lib/ARToolKit/examples/paddle/%.c
	@echo 'Building file: $<'

...
O_SRCS += \
../lib/ARToolKit/examples/twoView/twoView.o 

C_SRCS += \
../lib/ARToolKit/examples/twoView/twoView.c 

OBJS += \
./lib/ARToolKit/examples/twoView/twoView.o 

C_DEPS += \
./lib/ARToolKit/examples/twoView/twoView.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/examples/twoView/%.o: ../lib/ARToolKit/examples/twoView/%.c
	@echo 'Building file: $<'

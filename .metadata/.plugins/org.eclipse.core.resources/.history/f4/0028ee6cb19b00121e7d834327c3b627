...
O_SRCS += \
../lib/ARToolKit/util/graphicsTest/graphicsTest.o 

C_SRCS += \
../lib/ARToolKit/util/graphicsTest/graphicsTest.c 

OBJS += \
./lib/ARToolKit/util/graphicsTest/graphicsTest.o 

C_DEPS += \
./lib/ARToolKit/util/graphicsTest/graphicsTest.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/util/graphicsTest/%.o: ../lib/ARToolKit/util/graphicsTest/%.c
	@echo 'Building file: $<'

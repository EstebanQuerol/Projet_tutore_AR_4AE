...
C_SRCS += \
../lib/ARToolKit/util/mk_patt/mk_patt.c 

OBJS += \
./lib/ARToolKit/util/mk_patt/mk_patt.o 

C_DEPS += \
./lib/ARToolKit/util/mk_patt/mk_patt.d 


# Each subdirectory must supply rules for building sources it contributes
lib/ARToolKit/util/mk_patt/%.o: ../lib/ARToolKit/util/mk_patt/%.c
	@echo 'Building file: $<'

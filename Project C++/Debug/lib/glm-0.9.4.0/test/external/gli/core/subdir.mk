...
CPP_SRCS += \
../lib/glm-0.9.4.0/test/external/gli/core/dummy.cpp 

OBJS += \
./lib/glm-0.9.4.0/test/external/gli/core/dummy.o 

CPP_DEPS += \
./lib/glm-0.9.4.0/test/external/gli/core/dummy.d 


# Each subdirectory must supply rules for building sources it contributes
lib/glm-0.9.4.0/test/external/gli/core/%.o: ../lib/glm-0.9.4.0/test/external/gli/core/%.cpp
	@echo 'Building file: $<'
